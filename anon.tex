...
\emph{(iii)} explanations of the model’s predictive uncertainty (e.g., entropy, Dirichlet evidence) \cite{Slack2021Reliable,Hedstrom2023Quantus,Sensoy2018Evidential,Antoran2020Uncertainty,Watson2023InfoShapley,Brox2021BayesShap}.  
...
(4) produces structured, signed outputs that can be readily verbalized by LLMs into auditable narratives without losing the numeric grounding \cite{Arrieta2020XAI,Slack2023TalkToModel,Wang2024LLMJudge,Bilal2025LLMsXAI,Ribeiro2016LIME,Sundararajan2017IG}.  
...
Explaining individual predictions with Shapley values.
\textit{Journal of Machine Learning Research}, 22(102), 1--70.
...
\bibitem{Bilal2025LLMsXAI}
Bilal, A., Ebert, D., \& Lin, B. (2025).
LLMs for Explainable AI: A Comprehensive Survey.
\textit{ACM Transactions on Intelligent Systems and Technology}, 14(4) (to appear).
...
\bibitem{Murdoch2019Interpretable}
Murdoch, W. J., Singh, C., Kumbier, K., Abbasi-Asl, R., \& Yu, B. (2019).
Interpretable Machine Learning: Definitions, Methods, and Applications.
\textit{arXiv preprint arXiv:1901.04592}.
...
\bibitem{Wang2023LLMasJudge}
Wang, Y., Ivison, H., Hajishirzi, H., \& Choi, Y. (2023).
...
\bibitem{Slack2023TalkToModel}
Slack, D., Hilgard, S., Singh, S., \& Lakkaraju, H. (2023).
TalkToModel: Interpreting Machine Learning Models via Interactive Natural Language Conversations.
\textit{Proceedings of the 37th AAAI Conference on Artificial Intelligence (AAAI)}, 13764–13772.

\bibitem{Wang2024LLMJudge}
Wang, Y., Xu, K., He, Y., et al. (2024).
LLM-as-a-Judge: Assessing and Improving Text Generation Quality with Large Language Models.
\textit{Transactions on Machine Learning Research (TMLR)}, in press. Preprint available at arXiv:2308.07392.

\bibitem{Brox2021BayesShap}
Brox, T., Schmitt, M., \& Fuchs, T. (2021).
BayesSHAP: Bayesian Approach to Shapley Value-based Interpretability.
\textit{arXiv preprint arXiv:2107.08336}.
